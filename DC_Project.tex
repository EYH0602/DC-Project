...
It’s well-structured with three main sections discussing different functions of storytelling. 
They build up to support the main claim of my paper.
The current weakness of this draft is that the second and third sections lack enough details and analysis.
...
I have three questions about this draft.
...
Sometimes I did not realize I used wrong sentence structures or weird expressions.
...
Jerome Berger has argued that one of the important ways people understand their world is through storytelling, in which people express their wants, needs, and goals.. % source-checked
Davis points out that ``social movements are dominated by stories and storytelling, and narratives go to the heart of the very cultural and ideational processes'' (4), including public discourse, movement culture, and collective identity. % source-checked
...
For example, Edna, the CIYJA organizer suggested, 
    ``It was kinda helpful, but at the same time I think we really thought about the consequences of how it would create the two categories: `good immigrant' versus `bad immigrant''' (qtd. in Schwiertz 615). % source-checked
